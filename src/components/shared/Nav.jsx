...
export default function Nav() {
  ...
  return (
    <div className='border-2 border-t-sky-900 h-24 flex justify-between items-center px-16 py-2'>
        {/* Logo */}
        <div>
            <svg width="120px" viewBox="0 0 111 34" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
        ...
        <div className='xl:block sm:hidden text-gray-600 font-semibold '>
            ...
            <span className='hover:text-red-600 hover:underline cursor-pointer me-10 duration-300'>Pricing</span>
        ...
        <div className='track relative cursor-pointer font-semibold text-red-600 duration-300 hover: hover:shadow-lg px-10 rounded-ss-3xl rounded-se-3xl h-full flex items-center justify-center'>
            ...
            <div className="searching absolute -bottom-32 left-0 z-20 w-80 rounded-md border-2 px-10 py-6 bg-white">
                ...
                <input type="text" name="trackingNumber" onChange={formik.handleChange} onBlur={formik.handleBlur}
                placeholder='Tracking no.' value={formik.values.trackingNumber}
                className='h-10 rounded-s-md border ps-3 focus:outline-none placeholder:font-normal'/>

                <button type='submit'
                className='focus:outline-none border-none bg-red-600 text-white h-10 rounded-e-md
                px-4'><i className="fa-solid fa-magnifying-glass"></i></button>
                </form>
            </div>
